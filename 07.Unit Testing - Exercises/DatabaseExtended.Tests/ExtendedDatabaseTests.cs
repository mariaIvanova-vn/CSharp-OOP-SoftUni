...
namespace DatabaseExtended.Tests
{
    ...
    public class ExtendedDatabaseTests
    {
        ...
        {
            Person newPerson = new Person(1235, "Maria");
        ...
        {
            Assert.That(() => twoPeopleInDatabase.Add(new Person(3, "Maria1")), Throws.InvalidOperationException.With.Message
        ...
        {
            Person newPerson = new Person(12, "Mariana");
        ...
        {
            Assert.That(() => fullDatabase.FindByUsername("maria"),
        ...
        {
            Assert.That(() => fullDatabase.FindByUsername("Mariana"), Throws.InvalidOperationException.With.Message.EqualTo("No user is present by this username!"));
        }

        [Test]
        public void FindByUsernameShouldReturnPersonWithThatUsername()
        {
            Person result = fullDatabase.FindByUsername("Maria0");
            Person expected = new Person(1234, "Maria0");
        ...
        public void FindByIdShouldReturnPersonWithThatId()
        {
            ...
            Person expected = new Person(1235, "Maria1");
